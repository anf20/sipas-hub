...
class FeeTypeCreate extends Component
{
    ...
    {
        \Illuminate\Support\Facades\Log::info('Save method triggered', [
            'name' => $this->name,
        ...
        \Illuminate\Support\Facades\Log::info('Dispatching invoice generation (Sync)', [
        ...
        \Illuminate\Support\Facades\Log::error('Save failed', [
